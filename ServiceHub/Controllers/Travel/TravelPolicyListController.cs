...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class TravelPolicyListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<TravelPolicyListController> _logger;
        private readonly IConfiguration _configuration;

        public TravelPolicyListController(ILogger<TravelPolicyListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetTravelPolicyList]";
