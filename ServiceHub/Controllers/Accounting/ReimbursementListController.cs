...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ReimbursementListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<ReimbursementListController> _logger;
        private readonly IConfiguration _configuration;

        public ReimbursementListController(ILogger<ReimbursementListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetClaimList]";
