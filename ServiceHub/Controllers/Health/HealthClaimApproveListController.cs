...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class HealthClaimApproveListController  : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<HealthClaimApproveListController > _logger;
        private readonly IConfiguration _configuration;

        public HealthClaimApproveListController (ILogger<HealthClaimApproveListController > logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetHealthClaimList]";
                        ...
                        using (recordSet)
                        {
                            ...
                            while (recordSet.Read())
                            {
                                ...
                                if (initGrid == true)
                                    ...
                                    model = new GetGadazgevevaPolicyModel(); ///////////////// !!!!!!!! //////////
