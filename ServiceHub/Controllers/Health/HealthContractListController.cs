...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class HealthContractListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<HealthContractListController> _logger;
        private readonly IConfiguration _configuration;

        public HealthContractListController(ILogger<HealthContractListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.Parameters.AddWithValue("@saxeobaId", 5);
