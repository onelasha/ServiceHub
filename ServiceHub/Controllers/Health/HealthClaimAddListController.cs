...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class HealthClaimAddListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<HealthClaimAddListController> _logger;
        private readonly IConfiguration _configuration;

        public HealthClaimAddListController(ILogger<HealthClaimAddListController> logger, IConfiguration configuration)
        {
            _logger = logger;
