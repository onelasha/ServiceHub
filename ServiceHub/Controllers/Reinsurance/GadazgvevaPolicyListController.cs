...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class GadazgvevaPolicyListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<GadazgvevaPolicyListController> _logger;
        private readonly IConfiguration _configuration;

        public GadazgvevaPolicyListController(ILogger<GadazgvevaPolicyListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetGadazgevevaPolicyList]";
