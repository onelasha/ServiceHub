...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class AutoContractListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<AutoContractListController> _logger;
        private readonly IConfiguration _configuration;

        public AutoContractListController(ILogger<AutoContractListController> logger, IConfiguration configuration)
        {
            _logger = logger;
