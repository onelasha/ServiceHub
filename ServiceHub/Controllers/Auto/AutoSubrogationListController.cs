...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class AutoSubrogationListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<AutoSubrogationListController> _logger;
        private readonly IConfiguration _configuration;

        public AutoSubrogationListController(ILogger<AutoSubrogationListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetAutoSubrogationList]";
