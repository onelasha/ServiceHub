...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class AutoRegressListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<AutoRegressListController> _logger;
        private readonly IConfiguration _configuration;

        public AutoRegressListController(ILogger<AutoRegressListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetAutoRegressList]";
