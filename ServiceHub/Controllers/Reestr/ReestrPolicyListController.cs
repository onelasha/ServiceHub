...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ReestrPolicyListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<ReestrPolicyListController> _logger;
        private readonly IConfiguration _configuration;

        public ReestrPolicyListController(ILogger<ReestrPolicyListController> logger, IConfiguration configuration)
        {
            _logger = logger;
