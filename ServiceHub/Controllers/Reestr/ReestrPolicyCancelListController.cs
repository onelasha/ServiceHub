...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ReestrPolicyCancelListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<ReestrPolicyCancelListController> _logger;
        private readonly IConfiguration _configuration;

        public ReestrPolicyCancelListController(ILogger<ReestrPolicyCancelListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetPolicyList]";
