...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ReestrDebitorListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<ReestrDebitorListController> _logger;
        private readonly IConfiguration _configuration;

        public ReestrDebitorListController(ILogger<ReestrDebitorListController> logger, IConfiguration configuration)
        {
            _logger = logger;
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetDebitorList]";
