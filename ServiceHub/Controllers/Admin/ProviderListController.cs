...
namespace ServiceHub.Controllers
{
    ...
    public class ProviderListController : ControllerBase
    {
        ...
        private readonly ILogger<ProviderListController> _logger;
        private readonly IConfiguration _configuration;

        public ProviderListController(ILogger<ProviderListController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                ...
                rows = dbGetProviderList(ref totalRows);
            }
