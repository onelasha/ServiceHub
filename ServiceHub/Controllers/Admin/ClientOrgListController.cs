...
namespace ServiceHub.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class ClientOrgListController : ControllerBase
    {

        private LoginRequestJson _loginRequest;
        private readonly ILogger<ClientOrgListController> _logger;
        ...
        //private IEnumerable<dynamic> dbGetClientOrgList(ref int totalRecordCount )
        private dynamic dbGetClientOrgList(ref int totalRecordCount)
        {
            ...
            try
            {
                        ...
                        Request.Headers["X-WebGI-Version"])))
                {
                    ...
                    using (SqlCommand sqlCommand = sqlConnection.CreateCommand())
                    {
                        ...
                        sqlCommand.CommandText = "dbo.[usp_WebGI_GetClientOrgList]";
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                ...
                rows = dbGetClientOrgList(ref totalRows);
            }
